  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <main className="mt-[74px]">
        <section className="relative h-[310px] w-full overflow-hidden border-b border-slate-200 sm:h-[360px]">
          {hospital?.hospital_image ? (
            ...
            <div className="relative h-full w-full bg-gradient-to-br from-emerald-800 to-teal-950 flex items-center justify-center overflow-hidden">
              <div className="absolute opacity-10">
                <Building className="h-64 w-64 text-white stroke-[1]" />
              </div>
              <div className="absolute inset-0 bg-gradient-to-t from-slate-950/65 via-slate-900/20 to-transparent" />
            </div>
          )}
          <div className="absolute inset-x-0 bottom-0 px-4 pb-6 sm:px-6 lg:px-10">
            <div className="max-w-5xl">
              <p className="text-sm font-semibold text-emerald-200">{hospital?.hospital_type || 'Hospital'}</p>
              ...
              <p className="mt-2 inline-flex items-center gap-1.5 text-sm text-slate-200">
                <MapPin className="h-4 w-4 text-slate-300" />
                {hospital?.hospital_address || 'Address unavailable'}
              </p>
            </div>
          </div>
        </section>
