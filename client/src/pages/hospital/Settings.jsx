...
const HospitalSettings = () => {
  ...
  const handleFileChange = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setSavedMessage("Logo updated successfully!");
  ...
  const savePassword = async () => {
    ...
    try {
      ...
      await api.put("/auth/me/settings", payload);
      setForm({
        currentPassword: "",
        newPassword: "",
        confirmPassword: "",
  ...
  const displayName = user?.name || user?.full_name || "Hospital";
      ...
      <div className="space-y-6">
        ...
        <section className="space-y-6">
          <div className="border-b border-slate-200 pb-4">
            <h2 className="text-lg font-semibold text-slate-900">Hospital Logo</h2>
            <p className="mt-1 text-sm text-slate-500">
              Upload or update your hospital's public logo image.
            </p>
          </div>
